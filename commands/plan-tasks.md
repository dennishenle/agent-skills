---
description: Create a structured implementation plan with individual task files per task. Saves approved plan to .agents/plans/<feature-slug>/. Use /implement to execute tasks.
...
Create the plan directory: `.agents/plans/<feature-slug>/`
...
```
Plan saved: .agents/plans/<feature-slug>/
